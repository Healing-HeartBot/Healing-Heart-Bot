const moods = {
  mad: ['crazy', 'angry', 'anger', 'pissed', 'agitated', 'psychotic', 'furious', 'livid', 'fuming', 'infuriated', 'upset', 'raging', 'rageful', 'enraged', 'livid', 'irate', 'indignant', 'irritated', 'annoyed', 'psycho'],
  sad: ['bummed', 'depressed', 'heartbroken', 'melancholy', 'somber', 'blue', 'pensive', 'down', 'gloomy', 'low', 'crying', 'weepy', 'dejected', 'negative', 'hurt', 'awful', 'terrible', 'worst', 'unhappy', 'devastated', 'distraught'],
  weak: ['lame', 'desperate', 'longing', 'drunk', 'hopeless', 'insecure', 'fragile', 'delicate', 'miserable', 'overcome', 'despair', 'despairing'],
  hopeful: ['happy', 'optimistic', 'cheerful', 'confident', 'ready', 'upbeat', 'reassured', 'better', 'positive', 'promising', 'calm', 'fine', 'good', 'okay', 'relieved'],
