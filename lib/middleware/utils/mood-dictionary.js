const moods = {
  ...
  sad: ['depressed', 'heartbroken', 'melancholy', 'somber', 'blue', 'pensive', 'down', 'gloomy', 'low', 'crying', 'weepy', 'dejected', 'negative', 'hurt'],
  weak: ['lame', 'desperate', 'longing', 'drunk', ''],
...
// console.log(Object.entries(moods));

// const mood = 'abbeyalexallisonmaeve';
...
// console.log(moodMapper(moods, mood));
